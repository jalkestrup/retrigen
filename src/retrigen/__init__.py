...
def json_api_call(
    ...
    system_prompt: str,
    user_prompt: str,
    oai_model: str = "gpt-3.5-turbo-0125",
) -> Dict[str, Any]:
...
class QuestionContextManager:
    ...
    def question_context_pairs(self) -> List[Tuple[Document, List[Document]]]:
        ...
        return [
            (
                self.questions[qid],
                [self.contexts[cid] for cid in self.question_context_id_pairs[qid]],
            )
...
def generate_questions(
    textContexts: List[Union[Document, str]],
    num_questions: int = 1,
    oai_model: str = "gpt-4-0125-preview",
    duplicate_metadata: bool = True,
        ...
        try:
            ...
            for question_text in questions:
                question_document = Document(
                    ...
                    metadata=context.metadata if duplicate_metadata else {},
                )
...
def add_documents_to_chroma(
    ...
    id_document_pairs: Dict[str, Union[List[str], List[Document]]],
    document_prepend: str,
):
